...
background = pygame.image.load( r'C:\Users\user\Desktop\Новая папка\lab9\images\AnimatedStreet.png')
...
enemy_images = [pygame.image.load( r'C:\Users\user\Desktop\Новая папка\lab9\images\enemy2.png') for i in range(1, 4)]
...
class Coin(pygame.sprite.Sprite):
    ...
    def get_new_coin(self, coins = None):
        ...
        image = pygame.image.load( r'C:\Users\user\Desktop\Новая папка\lab9\images\coin.png')
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load( r'C:\Users\user\Desktop\Новая папка\lab9\images\player.png')
        self.rect = self.image.get_rect()
...
while True:
    ...
    if not losed:
        ...
        if pygame.sprite.spritecollideany(P1, enemies):
            pygame.mixer.Sound( r'C:\Users\user\Desktop\Новая папка\lab9\images\crash.wav').play()
            time.sleep(0.5)
